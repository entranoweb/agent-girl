...
Speed: Focus on clean implementation, not lengthy explanations.`,
  ...
  // ============================================================================
  // COPYWRITING AGENTS (Complete Integration - 14 Agents)
  // ============================================================================

  'copy-commander': {
    description: 'Master copywriting orchestrator - analyzes requests, routes to specialized sub-commanders, ensures quality standards',
  ...
  'social-commander': {
    description: 'Social media copy orchestrator - routes briefs for Instagram, TikTok, LinkedIn, platform-optimized posts and native ads',
    prompt: loadPromptFromFile('copywriting-agents/agents/social-media-sub-commander/prompt.md'),
    tools: ['Task', 'Read', 'Write'],
    model: 'sonnet',
  },

  'landing-commander': {
    description: 'Landing page copy orchestrator - creates comprehensive briefs for sales pages, opt-ins, webinars using proven direct response frameworks',
    prompt: loadPromptFromFile('copywriting-agents/agents/landing-page-sub-commander/prompt.md'),
    tools: ['Task', 'Read', 'Write'],
    model: 'sonnet',
  },

  'video-commander': {
    description: 'Video script orchestrator - creates production-ready briefs for short-form, VSLs, webinars, and explainers with platform optimization',
    prompt: loadPromptFromFile('copywriting-agents/agents/video-script-sub-commander/prompt.md'),
    tools: ['Task', 'Read', 'Write'],
    model: 'sonnet',
  },

  'research-agent': {
    description: 'Research and intelligence specialist - gathers audience insights, competitive analysis, and validates copy with real customer language',
    prompt: loadPromptFromFile('copywriting-agents/agents/research-agent/prompt.md'),
    tools: ['Read', 'Write', 'Grep'],
    model: 'sonnet',
  },

  'swipe-file-agent': {
    description: 'Swipe file library curator - retrieves proven copywriting patterns, formulas, and examples from legendary copywriters',
    prompt: loadPromptFromFile('copywriting-agents/agents/swipe-file-agent/prompt.md'),
    tools: ['Read', 'Write'],
    model: 'sonnet',
  },

  'headlines-specialist': {
    description: 'Headlines and hooks specialist - creates psychologically optimized headlines using proven formulas and triggers',
    prompt: loadPromptFromFile('copywriting-agents/agents/headlines-hooks-specialist/prompt.md'),
    tools: ['Read', 'Write'],
    model: 'sonnet',
  },

  'social-copywriter': {
    description: 'Social media copywriter - executes platform-optimized posts with native voice and engagement mechanics',
    prompt: loadPromptFromFile('copywriting-agents/agents/copy-writers/social/prompt.md'),
    tools: ['Read', 'Write'],
    model: 'sonnet',
  },

  'landing-copywriter': {
    description: 'Landing page copywriter - crafts conversion-focused long-form copy using direct response architecture',
    prompt: loadPromptFromFile('copywriting-agents/agents/copy-writers/landing/prompt.md'),
    tools: ['Read', 'Write'],
    model: 'sonnet',
  },

  'video-copywriter': {
    description: 'Video script writer - creates production-ready scripts with timing, hooks, and B-roll direction',
    prompt: loadPromptFromFile('copywriting-agents/agents/copy-writers/video/prompt.md'),
    tools: ['Read', 'Write'],
    model: 'sonnet',
  },

  'tone-voice-reviewer': {
    description: 'Tone and voice quality reviewer - ensures authentic, on-brand voice and eliminates AI-speak',
    prompt: loadPromptFromFile('copywriting-agents/agents/reviewers/tone-voice/prompt.md'),
    tools: ['Read', 'Write'],
    model: 'sonnet',
  },

  'psychology-reviewer': {
    description: 'Psychology and persuasion reviewer - validates trigger application and emotional resonance',
    prompt: loadPromptFromFile('copywriting-agents/agents/reviewers/psychology/prompt.md'),
    tools: ['Read', 'Write'],
    model: 'sonnet',
  },

  'audience-fit-reviewer': {
    description: 'Audience fit reviewer - validates persona alignment and customer language usage',
    prompt: loadPromptFromFile('copywriting-agents/agents/reviewers/audience-fit/prompt.md'),
    tools: ['Read', 'Write'],
    model: 'sonnet',
  },

  'entertainment-reviewer': {
    description: 'Entertainment and engagement reviewer - ensures copy maintains attention and drives readability',
    prompt: loadPromptFromFile('copywriting-agents/agents/reviewers/entertainment/prompt.md'),
    tools: ['Read', 'Write'],
    model: 'sonnet',
  },
};
